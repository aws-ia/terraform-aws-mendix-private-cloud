...
### Terraform Registry does not have a package available (Windows)

When initializing Terraform, Windows users may encounter an error referring to darwin_arm64.
