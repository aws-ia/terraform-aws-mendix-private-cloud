...
> The default EKS node instance type used on Mendix on Amazon EKS is optimized to support up to three apps. Deploying more than three apps may have an impact on the performance of your applications.
...
### 7.2 Cluster Waiting for Connection

In the Private Cloud Portal, in the Cluster Manager, the status of your cluster is shown as Waiting for Connection, but the cluster never connects.
