{
  ...
  "description": "Dashboard to evaluate the disk space usage of Prometheus, Grafana and Loki data.",
  "editable": true,
  ...
  "panels": [
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "kubelet_volume_stats_available_bytes{namespace=\"prometheus\",persistentvolumeclaim=\"prometheus-server\"}",
          "format": "time_series",
          "hide": false,
          "interval": "",
          "intervalFactor": 1,
    ...
    },
    {
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "kubelet_volume_stats_available_bytes{namespace=\"loki\",persistentvolumeclaim=\"storage-loki-stack-0\"}",
          "format": "time_series",
          "hide": false,
          "interval": "",
          "intervalFactor": 1,
        ...
        },
        {
          ...
          "editorMode": "code",
          "expr": "kubelet_volume_stats_used_bytes{namespace=\"loki\",persistentvolumeclaim=\"storage-loki-stack-0\"}",
          "format": "time_series",
          "interval": "",
          "intervalFactor": 1,
          "legendFormat": "{{persistentvolumeclaim}} Disk usage",
      ...
      "thresholds": [],
      "timeRegions": [],
      "title": "disk space used (PVC \"storage-loki-stack-0\")",
      "tooltip": {
        "shared": true,
        "sort": 0,
        "value_type": "individual"
  ...
  "timepicker": {},
  "timezone": "",
  "title": "Prometheus, Grafana and Loki disk space consumption evaluation",
  "uid": "TAiSVWQGzzz",
  "version": 1,
  "weekStart": ""
}