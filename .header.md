...
> Mendix on Amazon EKS is built to support up to three apps with high performance. Deploying more than three apps may have a negative result on the performance of your applications.
